                    ...
                    <div className="flex flex-col lg:flex-row">
                            ...
                            <div className="absolute inset-0 flex flex-col justify-between p-8">
                                ...
                                <div className="space-y-4">
                                    <h2 className="text-3xl font-bold leading-tight tracking-tight text-white">
                                        Bergabung untuk
                                        <br />
                                        <span className="text-emerald-300">Kelola Peternakan.</span>
                                    </h2>

                                    <p className="text-sm leading-relaxed text-emerald-100/80">
                                        Buat akun baru untuk memulai manajemen kandang, ternak, kesehatan, dan data AI.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col justify-center px-6 py-8 sm:px-10 sm:py-10 lg:w-[52%] lg:px-12 lg:py-10">
                            ...
                            <div className="space-y-1.5">
                                <h1 className="text-2xl font-bold tracking-tight text-foreground sm:text-3xl">Buat Akun Baru</h1>
                            </div>
